...
export type OnDisconnect = (kicked: boolean) => void;
...
export type HandlerByMultiplayerEvent<E extends MultiplayerEvents> =
...
export type EventHandlersMap = { [K in MultiplayerEvents]?: HandlerByMultiplayerEvent<K> }
